...
public class Usuario extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(usuario.getText().equals("examen") && password.getText().equals("aprobado")){
            
            Aprobado r=new Aprobado();
            r.setVisible(true);
                 dispose();
            jLabel1.setText("estas aprobado");
        }else{
             
            jLabel3.setText("Estas reprobado buey");
        }
